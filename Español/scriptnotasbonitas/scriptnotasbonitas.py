...
def ponerBonitoElTexto():
    ...
    resultado1=repr("".join(listaoracionesfinal)).replace("@z","\\\"" )
    nlineas2=contarlineas("".join(listaoracionesfinal))
    lineas.set(nlineas2)
...
label1= Label(text="@z= \\\"",font=("Arial",17) ).place(y=150,x=340)
label2= Label(text="\z = espacio entre parrafos\n PD: Tambien poner a la ultima linea",font=("Arial",17),foreground="#29BB32").place(y=200,x=330)
label3=Label(text="#lines in code:",font=("Arial",17),foreground="#29BB32").place(y=350,x=330)
label4=Label(textvariable=lineas,font=("Arial",17),foreground="#29BB32").place(y=350,x=480)
